...
// All territories with their neighbors for 41 Territories
  ...
  var TER1 = new Territory(gameid, 1, 0,'Brazil',  [ 3, 0, 2, 13 ] , 0, -1);
  var TER2 = new Territory(gameid, 2, 0,'PERU',  [ 3, 0, 1 ] , 0, -1);
  var TER3 = new Territory(gameid, 3, 0,'Argentina',  [ 0, 2 ] , 0, -1);
  ...
  var TER8 = new Territory(gameid, 8, 1,'Alaska',  [ 9, 11, 0 ] , 0, -1);
...
//31 countries
var TER0 = new Territory(gameid, 0, 'Veneru',  [ 1, 2, 3 ] , 0, -1);
var TER1 = new Territory(gameid, 1, 'Brazil',  [ 0, 2, 10 ] , 0, -1);
var TER2 = new Territory(gameid, 2, 'Argentina',  [ 0, 1 ] , 0, -1);
var TER3 = new Territory(gameid, 3, 'Western United States',  [ 0, 4, 7 ] , 0, -1);
var TER4 = new Territory(gameid, 4, 'Eastern United States',  [ 3, 5, 7 ] , 0, -1);
var TER5 = new Territory(gameid, 5, 'Eastern Canada',  [ 7, 4, 29 ] , 0, -1);
var TER6 = new Territory(gameid, 6, 'North Canada',  [ 7, 23, 29 ] , 0, -1);
var TER7 = new Territory(gameid, 7, 'Southwestern Canada',  [ 6, 5, 4, 3, 29 ] , 0, -1);
var TER8 = new Territory(gameid, 8, 'Middle Africa',  [ 9, 10, 21, 11 ] , 0, -1);
var TER9 = new Territory(gameid, 9, 'Egypt',  [ 10,12,8, 14 ] , 0, -1);
var TER10 = new Territory(gameid, 10, 'North Africa',  [  1, 9, 13, 14 ] , 0, -1);
var TER11 = new Territory(gameid, 11, 'South Africa',  [ 8,21 ] , 0, -1);
var TER12 = new Territory(gameid, 12, 'Middle East',  [ 14, 9, 8, 20, 30 ] , 0, -1);
var TER13 = new Territory(gameid, 13, 'Western Europe',  [ 18, 10, 14 ] , 0, -1);
var TER14 = new Territory(gameid, 14, 'Middle Europe',  [ 18, 13, 15, 16, 12, 9 ] , 0, -1);
var TER15 = new Territory(gameid, 15, 'Ukraine',  [ 16, 12, 14, 30] , 0, -1);
var TER16 = new Territory(gameid, 16, 'Scandinavia',  [ 15, 19, 14, 18 ] , 0, -1);
var TER17 = new Territory(gameid, 17, 'Middle Russia',  [ 24, 23, 22 ] , 0, -1);
var TER18 = new Territory(gameid, 18, 'Great Britain',  [ 19, 14, 16,13 ] , 0, -1);
var TER19 = new Territory(gameid, 19, 'Iceland',  [ 29, 18, 16 ] , 0, -1);
var TER20 = new Territory(gameid, 20, 'India',  [ 26, 22, 12, 30 ] , 0, -1);
var TER21 = new Territory(gameid, 21, 'Madagascar',  [ 11, 8 ] , 0, -1);
var TER22 = new Territory(gameid, 22, 'China',  [ 25, 17, 23, 26, 20, 24,30 ] , 0, -1);
var TER23 = new Territory(gameid, 23, 'Kamchatka',  [ 6, 25, 22, 17 ] , 0, -1);
var TER24 = new Territory(gameid, 24, 'Siberia',  [ 22, 17, 30] , 0, -1);
var TER25 = new Territory(gameid, 25, 'Japan',  [ 23, 22 ] , 0, -1);
var TER26 = new Territory(gameid, 26, 'Indonesia',  [ 22, 28, 27,20 ] , 0, -1);
var TER27 = new Territory(gameid, 27, 'New Guinea',  [ 26, 28 ] , 0, -1);
var TER28 = new Territory(gameid, 28, 'Australia',  [ 26, 27 ] , 0, -1);
var TER29 = new Territory(gameid, 29, 'Greenland',  [ 19, 5, 6 , 7  ] , 0, -1);
var TER30 = new Territory(gameid, 30, 'Western Asia',  [ 24, 12, 15, 20, 22 ] , 0, -1);
territories = [TER0,TER1,TER2,TER3,TER4,TER5,TER6,
				   TER7,TER8,TER9,TER10,TER11,TER12,TER13,
				   TER14,TER15,TER16,TER17,TER18,TER19,TER20,
				   TER21,TER22,TER23,TER24,TER25,TER26,TER27,
    ...
    function Player(gameid, pid, name, infantry, territories){
	  ...
	  var PLAYER2 = new Player(gameid, 1, "Misra", 20, []);
	 ...
	 /*
		 	...
		 	*/
		 	...
		 	socket.on('endturn', function(data){
		 		...
		 		console.log("endturn called from user");
		 		//let message = data.message;
